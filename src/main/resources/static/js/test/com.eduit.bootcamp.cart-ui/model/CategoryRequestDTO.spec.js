...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EduitRestShoppingCartApiOpenApi30.CategoryRequestDTO();
  });
  ...
  describe('CategoryRequestDTO', function() {
    it('should create an instance of CategoryRequestDTO', function() {
      // uncomment below and update the code to test CategoryRequestDTO
      //var instance = new EduitRestShoppingCartApiOpenApi30.CategoryRequestDTO();
      //expect(instance).to.be.a(EduitRestShoppingCartApiOpenApi30.CategoryRequestDTO);
    });
