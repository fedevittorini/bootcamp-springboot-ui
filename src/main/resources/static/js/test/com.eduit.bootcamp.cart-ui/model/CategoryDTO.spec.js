...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EduitRestShoppingCartApiOpenApi30.CategoryDTO();
  });
  ...
  describe('CategoryDTO', function() {
    it('should create an instance of CategoryDTO', function() {
      ...
      //var instance = new EduitRestShoppingCartApiOpenApi30.CategoryDTO();
      //expect(instance).to.be.a(EduitRestShoppingCartApiOpenApi30.CategoryDTO);
    });
