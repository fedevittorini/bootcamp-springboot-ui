...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EduitRestShoppingCartApiOpenApi30.DataResponseDTO();
  });
  ...
  describe('DataResponseDTO', function() {
    it('should create an instance of DataResponseDTO', function() {
      // uncomment below and update the code to test DataResponseDTO
      //var instance = new EduitRestShoppingCartApiOpenApi30.DataResponseDTO();
      //expect(instance).to.be.a(EduitRestShoppingCartApiOpenApi30.DataResponseDTO);
    });
