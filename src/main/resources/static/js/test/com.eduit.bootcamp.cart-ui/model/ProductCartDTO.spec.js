...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EduitRestShoppingCartApiOpenApi30.ProductCartDTO();
  });
  ...
  describe('ProductCartDTO', function() {
    it('should create an instance of ProductCartDTO', function() {
      // uncomment below and update the code to test ProductCartDTO
      //var instance = new EduitRestShoppingCartApiOpenApi30.ProductCartDTO();
      //expect(instance).to.be.a(EduitRestShoppingCartApiOpenApi30.ProductCartDTO);
    });
