...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EduitRestShoppingCartApiOpenApi30.OrderDTO();
  });
  ...
  describe('OrderDTO', function() {
    it('should create an instance of OrderDTO', function() {
      ...
      //var instance = new EduitRestShoppingCartApiOpenApi30.OrderDTO();
      //expect(instance).to.be.a(EduitRestShoppingCartApiOpenApi30.OrderDTO);
    });
