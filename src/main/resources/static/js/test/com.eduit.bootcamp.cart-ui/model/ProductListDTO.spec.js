...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EduitRestShoppingCartApiOpenApi30.ProductListDTO();
  });
  ...
  describe('ProductListDTO', function() {
    it('should create an instance of ProductListDTO', function() {
      // uncomment below and update the code to test ProductListDTO
      //var instance = new EduitRestShoppingCartApiOpenApi30.ProductListDTO();
      //expect(instance).to.be.a(EduitRestShoppingCartApiOpenApi30.ProductListDTO);
    });
