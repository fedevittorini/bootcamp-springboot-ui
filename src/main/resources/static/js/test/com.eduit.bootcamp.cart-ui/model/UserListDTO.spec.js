...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EduitRestShoppingCartApiOpenApi30.UserListDTO();
  });
  ...
  describe('UserListDTO', function() {
    it('should create an instance of UserListDTO', function() {
      // uncomment below and update the code to test UserListDTO
      //var instance = new EduitRestShoppingCartApiOpenApi30.UserListDTO();
      //expect(instance).to.be.a(EduitRestShoppingCartApiOpenApi30.UserListDTO);
    });
