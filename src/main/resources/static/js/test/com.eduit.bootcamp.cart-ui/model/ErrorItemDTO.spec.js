...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EduitRestShoppingCartApiOpenApi30.ErrorItemDTO();
  });
  ...
  describe('ErrorItemDTO', function() {
    it('should create an instance of ErrorItemDTO', function() {
      // uncomment below and update the code to test ErrorItemDTO
      //var instance = new EduitRestShoppingCartApiOpenApi30.ErrorItemDTO();
      //expect(instance).to.be.a(EduitRestShoppingCartApiOpenApi30.ErrorItemDTO);
    });
