...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EduitRestShoppingCartApiOpenApi30.EmptyResponseDTO();
  });
  ...
  describe('EmptyResponseDTO', function() {
    it('should create an instance of EmptyResponseDTO', function() {
      // uncomment below and update the code to test EmptyResponseDTO
      //var instance = new EduitRestShoppingCartApiOpenApi30.EmptyResponseDTO();
      //expect(instance).to.be.a(EduitRestShoppingCartApiOpenApi30.EmptyResponseDTO);
    });
